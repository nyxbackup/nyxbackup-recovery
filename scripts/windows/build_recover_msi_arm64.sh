...
# Same wixl-vs-DOS-timezone dance the x86_64 MSI does, including the
# best-effort powershell.exe probe and the local-clock fallback for when it is
# unusable (nested WSL invocation).  See build_recover_msi_x86_64.sh for the
# full rationale.
