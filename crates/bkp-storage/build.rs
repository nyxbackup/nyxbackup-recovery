...
// Dropbox and Google Drive - and a client_id alone for OneDrive, which
// is a public client - via `option_env!` so a `cargo
...
fn main() {
    for var in &[
        ...
        // OneDrive is a public client (loopback redirect, no secret) - see
        // bkp-oauth::onedrive.  Only the client_id is ever baked in.
